module.exports = function(RED) {
    function chaosGarbageCollector(config) {
        ...
        async function initialize() {
            try {
                ...
                await common.postJsonNoFetch("http://server:8080/options", { payload: config.cloneBranch }, 15000)
                    .then((res) => {
                        sRes = res;
                ...
                node.send({ payload: sRes.body.ok });
    ...
    RED.nodes.registerType("chaos-garbage-collector",chaosGarbageCollector);
}
